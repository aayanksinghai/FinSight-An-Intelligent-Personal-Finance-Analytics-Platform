      ...
      setProfileForm({
        ...
        monthlyIncome:
          profileData.monthlyIncome != null
            ? String(profileData.monthlyIncome)
            : "",
      });
    } catch (err) {
      ...
      <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
        ...
        <div className="glass-card p-6">
          ...
          >
            ...
            <div className="field">
              <label htmlFor="profile-age-group" className="form-label">
                Age group
              </label>
              <select
                ...
                onChange={(e) =>
                  setProfileForm((p) => ({ ...p, ageGroup: e.target.value }))
                }
              >
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="glass-card p-6">
            ...
            <div className="flex flex-col gap-2.5 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span
                  className={
                    profile?.profileConfigured ? "text-success" : "text-muted"
                  }
                >
          ...
          <div className="glass-card p-6">
            ...
            >
              ...
              <div className="field">
                <label htmlFor="new-password-profile" className="form-label">
                  New password
                </label>
                <input
                ...
                <p className="mt-1.5 text-[11px] text-muted">
                  {getPasswordPolicyHint(passwordPolicy)}
                </p>
              </div>
              <button
                type="submit"
